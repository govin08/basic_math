...
\end{equation}
Here, we compute the covariance function of this model for \(h=0,1,2,\cdots\).

To get the autocovariance function \(\gamma(h)=\cov(X_t,X_{t-h})\), multiply \eqref{arma(1,1)} by \(X_{t-h}\) on both sides 
